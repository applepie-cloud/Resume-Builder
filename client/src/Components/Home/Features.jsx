...
const Features = () => {
  ...
  return (
     <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title='Build Your Resume' description='Transform your career story into a standout, ATS-friendly resume in minutes with AI-powered tailoring and professional templates'/>
