...
const Testimonials = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">Great resume building website.</p>
  ...
  return (
   ...
   <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title='What Our Users Say' description='See how thousands of job seekers landed interviews at top companies using our AI resume builder'/>
    </div>
