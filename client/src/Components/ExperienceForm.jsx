...
const ExperienceForm = ({data = [], onChange}) => {
    ...
    const generateDescription = async(index) => {
        ...
        const prompt = `enhance this job description ${experience.description} for a position of ${experience.position} at ${experience.company}`
        try {
        ...
        <div className="flex items-center justify-between">
            <div>
                ...
                <p className="text-sm text-gray-500">
                    Add details for your experience here
                </p>
            </div>
            <button 
                ...
                {data.map((experience, index) => (
                    <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3"> 
                        ...
                        <div className="space-y-2"> 
                            ...
                            <textarea rows={4} className="w-full text-sm px-3 py-2 rounded-lg resize-none"
